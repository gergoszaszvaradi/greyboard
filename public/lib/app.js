...
app.registerShortcut(37, false, false, false, () => { if (toolbox.selected == toolbox.select)
    toolbox.select.moveSelection(10 / viewport.scale, 0); });
app.registerShortcut(38, false, false, false, () => { if (toolbox.selected == toolbox.select)
    toolbox.select.moveSelection(0, 10 / viewport.scale); });
app.registerShortcut(39, false, false, false, () => { if (toolbox.selected == toolbox.select)
    toolbox.select.moveSelection(-10 / viewport.scale, 0); });
app.registerShortcut(40, false, false, false, () => { if (toolbox.selected == toolbox.select)
    toolbox.select.moveSelection(0, -10 / viewport.scale); });
